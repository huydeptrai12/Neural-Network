# nn/nn/dropout/models.py
# Local application/library specific imports
from nn.commons.models import Layer
from nn.dropout.forward import dropout_forward
from nn.dropout.backward import dropout_backward
from nn.dropout.parameters import (
...
class Dropout(Layer):
    ...
    def compute_shapes(self, A):
        """Wrapper for :func:`nn.dropout.parameters.dropout_compute_shapes()`.
    ...
    def initialize_parameters(self):
        """Wrapper for :func:`nn.dropout.parameters.dropout_initialize_parameters()`.
        """
    ...
    def forward(self, A):
        """Wrapper for :func:`nn.dropout.forward.dropout_forward()`.
    ...
    def backward(self, dX):
        """Wrapper for :func:`nn.dropout.backward.dropout_backward()`.
    ...
    def compute_gradients(self):
        """Wrapper for :func:`nn.dropout.parameters.dropout_compute_gradients()`. Dummy method, there are no gradients to compute in layer.
        """
    ...
    def update_parameters(self):
        """Wrapper for :func:`nn.dropout.parameters.dropout_update_parameters()`. Dummy method, there are no parameters to update in layer.
        """
        if self.trainable:
