...
def model_initialize(model, params=True, end='\n'):
    ...
    :param model: An instance of nn network.
    ...
    :raises Exception: If any layer other than Dense was provided with softmax activation. See :func:`nn.maths.softmax`.
    """
    ...
    cprint('{: <100}'.format('--- nn Check --- '), attrs=['bold'], end=end)
    ...
    for layer in model.layers:
        ...
        # Dense uses nn.maths.hadamard to handle softmax derivative
        ...
        # nn_train layer.compute_shapes() method
    ...
    for layer in reversed(model.layers):
        ...
        # nn_train layer.backward() method
        ...
        # nn_train layer.compute_gradients() method
    ...
    cprint('{: <100}'.format('--- nn Check OK! --- '), attrs=['bold'], end=end)
...
def model_initialize_exceptions(model, trace):
    ...
    """
    cprint('\n/!\\ Initialization of nn model failed - debug', 'red', attrs=['bold'])
