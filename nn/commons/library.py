...
from nn.commons.logs import process_logs
...
def settings_verification():
    """Import default :class:`nn.settings.se_hPars` if not present in working directory.
    """
    # Absolute path of nn directory
