...
def model_evaluate(model):
    ...
    Will evaluate training, nn_training and validation sets against metrics set in model.se_config.
    ...
    # Iterate over dsets [dtrain, dval, dnn_train]
