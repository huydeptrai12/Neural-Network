# nn/nn/dense/models.py
# Local application/library specific imports
from nn.commons.models import Layer
from nn.commons.maths import (
    sigmoid,
    xavier,
    activation_tune,
)
from nn.dense.forward import dense_forward
from nn.dense.backward import dense_backward
from nn.dense.parameters import (
...
class Dense(Layer):
    ...
    def compute_shapes(self, A):
        """Wrapper for :func:`nn.dense.parameters.dense_compute_shapes()`.
    ...
    def initialize_parameters(self):
        """Wrapper for :func:`nn.dense.parameters.dense_initialize_parameters()`.
        """
    ...
    def forward(self, A):
        """Wrapper for :func:`nn.dense.forward.dense_forward()`.
    ...
    def backward(self, dX):
        """Wrapper for :func:`nn.dense.backward.dense_backward()`.
    ...
    def compute_gradients(self):
        """Wrapper for :func:`nn.dense.parameters.dense_compute_gradients()`.
        """
    ...
    def update_parameters(self):
        """Wrapper for :func:`nn.dense.parameters.dense_update_parameters()`.
        """
        if self.trainable:
