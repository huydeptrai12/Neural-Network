...
class Convolution(Layer):
    ...
    def compute_shapes(self, A):
        """Wrapper for :func:`nn.convolution.parameters.convolution_compute_shapes()`.
    ...
    def initialize_parameters(self):
        """Wrapper for :func:`nn.convolution.parameters.convolution_initialize_parameters()`.
        """
    ...
    def forward(self, A):
        """Wrapper for :func:`nn.convolution.forward.convolution_forward()`.
    ...
    def backward(self, dX):
        """Wrapper for :func:`nn.convolution.backward.convolution_backward()`.
    ...
    def update_parameters(self):
        """Wrapper for :func:`nn.convolution.parameters.convolution_update_parameters()`.
        """
        if self.trainable:
