# nn/nn/embedding/parameters.py
# Related third party imports
import numpy as np

# Local application/library specific imports
from nn.commons.models import Layer
from nn.embedding.dataset import (
    embedding_prepare,
    embedding_encode,
    embedding_check,
    mini_batches,
)
from nn.embedding.forward import embedding_forward
from nn.embedding.backward import embedding_backward
from nn.embedding.parameters import (
...
class Embedding(Layer):
    ...
    :param relative_size: For training, validation and nn_training sets. Defaults to `(2, 1, 1)`
    ...
    def __init__(self,
        ...
        self.se_dataset = {
            ...
            'dnn_train_relative': relative_size[2],
        ...
        # print(X_data.shape, Y_data.shape)
        # print(Y_data[:10])
        self.dtrain, self.dval, self.dnn_train = embedded_data

        # Keep non-empty datasets
        self.dsets = [self.dtrain, self.dval, self.dnn_train]
    ...
    def training_batches(self, init=False):
        """Wrapper for :func:`nn.embedding.dataset.mini_batches()`.
    ...
    def compute_shapes(self, A):
        """Wrapper for :func:`nn.embedding.parameters.embedding_compute_shapes()`.
    ...
    def initialize_parameters(self):
        """Wrapper for :func:`nn.embedding.parameters.embedding_initialize_parameters()`.
        """
    ...
    def forward(self, A):
        """Wrapper for :func:`nn.embedding.forward.embedding_forward()`.
    ...
    def backward(self, dX):
        """Wrapper for :func:`nn.embedding.backward.embedding_backward()`.
    ...
    def compute_gradients(self):
        """Wrapper for :func:`nn.embedding.parameters.embedding_compute_gradients()`. Dummy method, there are no gradients to compute in layer.
        """
    ...
    def update_parameters(self):
        """Wrapper for :func:`nn.embedding.parameters.embedding_update_parameters()`. Dummy method, there are no parameters to update in layer.
        """
        if self.trainable:
